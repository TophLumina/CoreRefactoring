...
struct vec<3, T>
{
    ...
    template <typename U>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(U scalar) : x(static_cast<T>(scalar)), y(static_cast<T>(scalar)), z(static_cast<T>(scalar)) {}

    template <typename U>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(const vec<3, U> &v) : x(static_cast<T>(v.x)), y(static_cast<T>(v.y)), z(static_cast<T>(v.z)) {}

    template <typename U>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(const vec<4, U> &v) : x(static_cast<T>(v.x)), y(static_cast<T>(v.y)), z(static_cast<T>(v.z)) {}

    template <typename A, typename B>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(A x, const vec<2, B> &v) : x(static_cast<T>(x)), y(static_cast<T>(v.x)), z(static_cast<T>(v.y)) {}

    template <typename A, typename B>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(const vec<2, A> &v, B z) : x(static_cast<T>(v.x)), y(static_cast<T>(v.y)), z(static_cast<T>(z)) {}

    template <typename A, typename B, typename C>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(A x, B y, C z) : x(static_cast<T>(x)), y(static_cast<T>(y)), z(static_cast<T>(z)) {}

    template <typename A, typename B, typename C>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(const vec<1, A> &v, B y, C z) : x(static_cast<T>(v.x)), y(static_cast<T>(y)), z(static_cast<T>(z)) {}

    template <typename A, typename B, typename C>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(A x, const vec<1, B> &v, C z) : x(static_cast<T>(x)), y(static_cast<T>(v.x)), z(static_cast<T>(z)) {}

    template <typename A, typename B, typename C>
    MATH_FUNCTION_QUALIFIERS MATH_EXPLICIT vec(A x, B y, const vec<1, C> &v) : x(static_cast<T>(x)), y(static_cast<T>(y)), z(static_cast<T>(v.x)) {}
    ...
    template <typename U>
    MATH_FUNCTION_QUALIFIERS vec &operator+=(const vec<3, U> &v)
    {
        x += static_cast<T>(v.x);
        y += static_cast<T>(v.y);
        z += static_cast<T>(v.z);
